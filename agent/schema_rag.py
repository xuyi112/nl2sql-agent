...
BUSINESS_DOCS = {
    ...
    "上月": "上月 = 上一自然月。例如当前 2026-08,上月就是 2026-07-01 到 2026-07-31。查询上月数据必须在 WHERE 里加 order_date 的日期范围过滤",
    "上季度": "上季度 = 上一自然季度。例如当前 2026-08(三季度),上季度就是 2026-04-01 到 2026-06-30。查询上季度数据必须在 WHERE 里加 order_date 的日期范围过滤",
    "同比": "同比 = 与去年同月/同季度对比",
    "环比": "环比 = 与上一月/上一季度对比",
